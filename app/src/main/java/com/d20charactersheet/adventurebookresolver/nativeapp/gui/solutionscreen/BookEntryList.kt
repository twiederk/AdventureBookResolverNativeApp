...
@Composable
fun BookEntryList(bookEntryList: List<BookEntry>, onBookEntryClick: (BookEntry) -> Unit) {
    LazyColumn(
...
@Composable
fun BookEntryCard(bookEntry: BookEntry, onBookEntryClick: (BookEntry) -> Unit) {
    Surface(
        modifier = Modifier.clickable { onBookEntryClick(bookEntry) },
