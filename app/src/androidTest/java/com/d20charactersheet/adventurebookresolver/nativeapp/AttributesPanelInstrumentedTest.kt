...
class AttributesPanelInstrumentedTest : KoinTest {
    ...
    fun check_initial_layout() {
        ...
        onView(withId(R.id.strength_plus_button)).check(matches(withText(R.string.plus_sign)))
        onView(withId(R.id.strength_minus_button)).check(matches(withText(R.string.minus_sign)))

        onView(withId(R.id.dexterity_text_view)).check(matches(withText(R.string.dexterity)))
        onView(withId(R.id.dexterity_value_text_view)).check(matches(withText("8 / 9")))
        onView(withId(R.id.dexterity_plus_button)).check(matches(withText(R.string.plus_sign)))
        onView(withId(R.id.dexterity_minus_button)).check(matches(withText(R.string.minus_sign)))

        onView(withId(R.id.luck_text_view)).check(matches(withText(R.string.luck)))
        onView(withId(R.id.luck_value_text_view)).check(matches(withText("5 / 10")))
        onView(withId(R.id.luck_plus_button)).check(matches(withText(R.string.plus_sign)))
        onView(withId(R.id.luck_minus_button)).check(matches(withText(R.string.minus_sign)))
    }
